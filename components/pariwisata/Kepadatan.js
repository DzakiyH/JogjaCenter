...
import styles from './Kepadatan.module.css';

class Kepadatan extends Component {
    render() {
        return (
            <div className={styles.kepadatan}>
                <h4>Data analytics - Pariwisata</h4>
                <div id="map-kepadatan" style={{ height: 500 }}></div>
            </div>
        )
    }
    ...
    componentDidMount() {
        ...
        container: 'map-kepadatan', // container element id
